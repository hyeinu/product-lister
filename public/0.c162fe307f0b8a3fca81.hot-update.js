...
/***/ function(module, exports, __webpack_require__) {
	...
	var Home = _wrapComponent('_component')(_react3.default.createClass({
	  ...
	  sortName: function (_sortName) {
	    function sortName() {
	      return _sortName.apply(this, arguments);
	    }

	    sortName.toString = function () {
	      return _sortName.toString();
	    };
	    ...
	    if (sortName) {
	      var _sortArr = this.state.productlist.sort(function (a, b) {
	        return a.name - b.name;
	        _this.setState({ sortName: false });
	      });
	    } else {
	      var _sortArr2 = this.state.productlist.sort(function (a, b) {
